  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
      <div className="bg-[#FFF9E5] rounded-xl p-5 border border-[#FFEAB5] flex gap-4">
        ...
        <div>
          <h3 className="font-bold text-slate-800 text-sm mb-1">Why do I have this challan?</h3>
          <p className="text-xs text-slate-600 mb-3 leading-relaxed">
            Traffic rules are in place to ensure everyone's safety.
          </p>
          <a href="#" className="text-blue-600 text-xs font-semibold flex items-center hover:underline">
            Learn more about common violations <ChevronRight className="w-3 h-3 ml-0.5" />
          </a>
        </div>
      </div>
      ...
      <div className="bg-[#F0F9FF] rounded-xl p-5 border border-[#BAE6FD] flex gap-4">
        ...
        <div>
          <h3 className="font-bold text-slate-800 text-sm mb-1">How to pay?</h3>
          <p className="text-xs text-slate-600 mb-3 leading-relaxed">
            You can pay online instantly and get digital receipt.
          </p>
          <a href="#" className="text-blue-600 text-xs font-semibold flex items-center hover:underline">
            View payment guide <ChevronRight className="w-3 h-3 ml-0.5" />
          </a>
        </div>
      </div>
      ...
      <div className="bg-[#F8FAFC] rounded-xl p-5 border border-[#E2E8F0] flex gap-4">
        ...
        <div>
          <h3 className="font-bold text-slate-800 text-sm mb-1">Disagree with challan?</h3>
          <p className="text-xs text-slate-600 mb-3 leading-relaxed">
            You can challenge this challan if you believe it is incorrect.
          </p>
          <a href="#" className="text-blue-600 text-xs font-semibold flex items-center hover:underline">
            Know how to challenge <ChevronRight className="w-3 h-3 ml-0.5" />
          </a>
        </div>
      </div>
    </div>
