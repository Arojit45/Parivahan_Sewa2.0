...
const Step1State = () => {
  ...
  const handleSelect = (s) => {
    updateFields({ state: s.name, stateCode: s.code });
  };
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-8 pt-8 pb-4">
        <div className="flex items-center gap-3 mb-1">
          ...
          <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide">Step 1 of 9</p>
        </div>
        <h2 className="text-2xl font-bold text-slate-900 mb-1">Where are you applying?</h2>
        <p className="text-slate-500 text-sm font-medium">Select the state/UT where you want to apply for your Driving Licence.</p>
      </div>
