        ...
        <div className="flex justify-between items-start mb-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-xl font-bold text-slate-900">Hyundai Creta</h1>
              <span className="bg-emerald-100 text-emerald-700 text-[9px] font-bold px-2 py-0.5 rounded-sm tracking-wider uppercase">Active</span>
            ...
            <p className="text-[11px] text-slate-500 font-medium mt-3">Petrol • LMV • SUV</p>
          </div>
